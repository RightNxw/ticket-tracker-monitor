...
export class VividSeatsMonitor {
    ...
    try {
      ...
      for (const venue of venues) {
        ...
        const res = await axios.post(
          "https://ticket-tracker-omega.vercel.app/api/venue",
          {
            id: venue.id,
            date: {
        ...
        const venueResponse = await axios.get(
          `https://ticket-tracker-omega.vercel.app/api/venue?id=${venue.id}`
        );
  ...
  async fetchAdditionalVenueInfo(venueId: number): Promise<void> {
    try {
      ...
      await axios.post("https://ticket-tracker-omega.vercel.app/api/venue", {
        id: venueId,
        artist: artistName,
        stadium: stadiumName,
        vividUrl: venueUrl,
